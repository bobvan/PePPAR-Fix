...
plot time:
    ...
    utc_iso,mono_s,prn,sys,component,signal,value_m,value_ns,iod,epoch_s
...
def main():
    ...
    ssr = SSRState()
    out = open(args.out, "w")
    out.write("utc_iso,mono_s,prn,sys,component,signal,value_m,value_ns,iod,epoch_s\n")
